...
const Navbar = () => {
  ...
  const nav = (e) => {
    ...
    setn6(false)
    if (sw)
      e.currentTarget.id == "n1" ? setn1(!n1) : e.currentTarget.id == "n2" ? setn2(true) : e.currentTarget.id == "n3" ? setn3(!n3) : e.currentTarget.id == "n4" ? setn4(!n4) : e.currentTarget.id == "n5" ? setn5(!n5) : e.currentTarget.id == "n6" ? setn6(!n6) : ""
    else
        ...
        {sw ? <div className='flex justify-between w-full '>
          ...
          <div id='n6' onMouseEnter={(e) => nav(e)} className='under'><span className=' transition-all duration-300 cursor-pointer  flex gap-[0.5vw] items-center'>Investors </span>
            ...
            <li className='p-[1vw] relative hover:text-orange-400 hover: cursor-pointer  transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw]' onClick={() => Router.push("/regulation-46-and-62-of-sebi-[LODR]")}>Regulation 46 and 62 of sebi-[LODR]</li>
              ...
              <li id='s4' onMouseLeave={() => sets4(false)} onMouseEnter={(e)=>sub(e)} className='p-[1vw] relative hover:text-orange-400 hover: cursor-pointer  transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw]'>Financials
               {s4 && <span onMouseLeave={() => sets4(false)} className='flex flex-col absolute top-0 drop-shadow-xl  w-[14vw] left-[16vw] text-[#333333] bg-white  '>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vw]' onClick={() => Router.push("/annual-report")}>Annual Reports</span>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vw]' onClick={() => Router.push("/financials")}>Financial Statements</span>
              ...
              <li id='s6' onMouseLeave={() => sets6(false)} onMouseEnter={(e)=>sub(e)} className='p-[1vw] relative hover:text-orange-400 hover: cursor-pointer  transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw]'>Intimation
               {s6 && <span onMouseLeave={() => sets6(false)} className='flex flex-col absolute top-0 drop-shadow-xl  w-[14vw] left-[16vw] text-[#333333] bg-white  '>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vw]' onClick={() => Router.push("/latest-updates")}>Board Meeting</span>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vw]' onClick={() => Router.push("/agm-egm")}>AGM/EGM/Postal Ballot</span>
                </span>}</li>
            ...
            {n2 && <ul className='  border-t-[0.2vw] text-[#333333] border-orange-400 top-[7vw] [&>*]:pl-2 bg-white '>
              <li id='s1' onClick={(e) => sub(e)} className=' hover:text-orange-400 hover: cursor-pointer relative transition-all duration-300 border-b  p-[1vh] hover:pl-[1.5vw]' ><span onClick={() => Router.push("/batteries")} className=" "><span className='flex items-center gap-4'>Batteries <BsChevronDown /></span></span>
                {s1 && <span className='flex flex-col  top-0 [&>*]:ml-2  text-[#333333]   '>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vh]' onClick={() => Router.push("/E-rickshaw-battery")}>E-Rickshaw</span>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vh]' onClick={() => Router.push("/Inverter-battery")}>Inverter Batteries</span>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300  hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vh]' onClick={() => Router.push("/Solar-battery")}>Solar Battery</span>
                </span>}
              </li>
              <li id='s2' onClick={(e) => sub(e)} className='p-[1vh] relative hover:text-orange-400 hover: cursor-pointer  transition-all duration-300  hover:pl-[1.5vw]'><span className='flex items-center gap-4'>Electric Vehicles<BsChevronDown /></span>
                {s2 && <span className='flex flex-col  top-0  [&>*]:ml-2  text-[#333333]   '>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vh]' onClick={() => Router.push("/scooty")}>Scooty</span>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 border-b hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vh]' onClick={() => Router.push("/e-rickshaw")}>E-Rickshaw</span>
                  <span className='hover:text-orange-400 hover:cursor-pointer transition-all duration-300 hover:bg-[#f9f9f9] hover:pl-[1.5vw] p-[1vh]' onClick={() => Router.push("/loader")}>Loader</span>
                </span>}
              </li>
            </ul>}
          </div>
