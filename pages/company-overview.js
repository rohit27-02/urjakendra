  ...
  return (
    <div className='overflow-hidden text-base'>
        ...
        <div className='py-[4vw] text-center '>
            <h1 className='text-orange-500 font-bold mx-auto text-4xl border-b-4 border-gray-700 pb-[1vw] mb-[1vw] w-fit'>URJA GLOBAL LIMITED</h1>
            <p className='text-2xl font-semibold'>URJA GLOBAL LIMITED IS IN ONE OF INDIA&apos;S LEADING RENEWABLE ENERGY DEVELOPERS</p>
        </div>
        <div className='relative overflow-hidden gap-[6vw] pb-[4vw] flex font-medium'>
        
            <div className='w-3/5 space-y-5 leading-loose tracking-wide text-justify ml-[4vw]'>
            ...
            <div className='w-2/5 space-y-5 leading-loose text-justify tracking-wide mr-[4vw]'>
