...
const complaint = () => {
  return (
    <div>
      ...
      <div className='pb-[60vw] relative'>
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input type="Registered Mobile No." id="Registered Mobile No." name="Registered Mobile No." className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                  </div>
                </div>
                <div className="p-2 w-1/2">
                  <div className="relative">
                    <label for="Alternate Mobile No." className="leading-7 text-sm text-gray-600">Alternate Mobile No.</label>
                    <input type="Alternate Mobile No." id="Alternate Mobile No." name="Alternate Mobile No." className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                  </div>
                </div>
                <div className="p-2 w-1/2">
                  <div className="relative">
                ...
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input type="Complaint Type" id="Complaint Type" name="Complaint Type" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                  </div>
                </div>
                <div className="p-2 w-1/2">
                  <div className="relative">
                ...
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input type="Problem Detail." id="Problem Detail." name="Problem Detail." className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                  </div>
                </div>
