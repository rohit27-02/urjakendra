...
const ourleadership = () => {
    return (
        <div className=' text-center text-gray-600 leading-relaxed font-medium tracking-wide bg-gray-100'>
            ...
            <div className='px-32 mt-16'>
                <h1 className='text-4xl font-bold mx-20'>Tata Power, the largest integrated power company in India,
