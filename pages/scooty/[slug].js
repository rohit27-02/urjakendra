...
const Scootydetails = () => {
    ...
    const pic=["/Urja E-Zess 1.png","/Urja E-life 1.1.png"]
    useEffect(() => {
        console.log(Router.asPath)
        if(Router.asPath=="/scooty/urja-xl")
        setpicture(pic[0])
        else
        setpicture(pic[1])
    }, []);
  return (
    <div className='mt-[8vh] md:mt-[7vw]'>
        ...
        <div className='mt-20'>
            ...
            <div className='flex mt-6 w-[60%] h-[60%] mx-auto'>
                <div className='mt-20 w-2/3  font-semibold space-y-6 text-orange-500'>
                ...
                <div>
                    <img className=' ml-16 w-[90%]' src={picture} alt='scooty-image'/>
                </div>
            </div>
        </div>
        {/* <div className='bg-[#53C2D1] flex w-full h-[90vh]'>
            <img className='w-[55%] h-auto object-contain self-start' src='/Urja E-life 4.png' alt='front'/>
        ...
        <div className=' flex w-full justify-between h-[90vh]'>
            ...
            <img className='p-10' src='/Urja E-life 3.png' alt='front'/>
        </div>
        <div className='bg-[#53C2D1] flex w-full h-[90vh]'>
