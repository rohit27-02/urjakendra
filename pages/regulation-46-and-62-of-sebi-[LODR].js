...
{name:"Terms and conditions of appointment of independent directors",link:"/Regulations/CommontermsandconditionsofappointmentofIndependentDirectors.pdf"},
{name:"Composition of various committees of board of directors",link:"/Regulations/Composition of Committees of the Board of Directors.pdf"},
{name:"Code of conduct of board of directors and senior management personnel",link:"/Regulations/CODE OF CONDUCT FOR DIRECTORS AND SENIOR MANAGEMENT PERSONNEL.pdf"},
{name:"Details of establishment of vigil mechanism/Whistle Blower Policy",link:"/Regulations/Whistle Blower Policy.pdf"},
{name:"Criteria of making payment to non-executive directors, if the same has not been",link:"/Regulations/Nomination and Remuneration Policy_UGL.pdf"},
{name:"Policy of dealing with related party transactions",link:"/Regulations/Policy on Related Party Transaction.pdf"},
{name:"Policy for determining material subsidiaries",link:"/Regulations/POLICY FOR DETERMINATION OF MATERIAL SUBSIDIARY AND GOVERNANCE OF SUBSIDIARY.pdf"},
...
{name:"All credit ratings obtained by the entity for all its outstanding instruments, updated immediately as and when there is any revision in any of the ratings",link:"/Regulations/Credit Rating.pdf"},
...
{name:"Secretarial Compliance Report",link:"/Regulations/AnnualSecretarialComplianceReport2022.pdf"},
{name:"Disclosure of the policy for determination of materiality of events or information required under clause (ii), sub-regulation (4) of regulation 30 of these regulations",link:"/Regulation/Disclosure of materiality-UGL.pdf"},
    ...
    <div className='mt-[8vh] md:mt-[7vw] '>
        ...
        <div className='my-[2vw]'>
           ...
           {Object.keys(data).map((i)=>{
            ...
            <div className='w-[15%] border p-[1vw] text-3xl'>{!data[i].link?<span className='text-base text-gray-500'>Not Applicable</span>:data[i].link.includes(".pdf")?<img onClick={()=>Router.push(`${data[i].link}`)} className='h-4 md:h-7 mx-auto cursor-pointer' src='/pdf_icon.png' alt='icon' />:<GoLinkExternal onClick={()=>Router.push(`${data[i].link}`)} className='w-fit mx-auto cursor-pointer'/>}</div>
        </div>
           }) }
