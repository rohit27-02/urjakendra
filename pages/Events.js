...
const Events = () => {
  ...
  return (
    <div onClick={()=>{event.current.classList.add("hidden")}} className='bg-gray-50'>
      ...
      <div ref={event} className='fixed backdrop-blur-sm top-0 flex justify-center items-center  left-0 z-50 h-[100%]  w-[100%] '>
        <Zoom>
          <img className='w-[30%] h-auto fixed' src='/events banner.jpg' />
        </Zoom>
      </div>
