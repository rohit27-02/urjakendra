    ...
    return (
        <div className='mt-[8vh] md:mt-[7vw]'>
            ...
            <div className='flex gap-[2vh] md:gap-[2vw] mt-[2vh] md:mt-[2vw] ml-[4vh] md:ml-[6vw] font-semibold'>
                ...
                <div id='next' className='cursor-pointer underline underline-offset-[0.7vw] transition-all duration-200 ease-in-out hover:text-orange-500 text-sm md:text-[1.4vw]' onClick={(e) => { parseInt(Router.asPath.split("/")[2]) < 3 ? Router.push(`/corporate-governance-report/${parseInt(Router.asPath.split("/")[2]) + 1}`) : "" }}>Next</div>
            </div>
            <Investor id="1" pdfs={pdfs} folder={"board committee"} />
            <Investor id="corporate" pdfs={pdfs1} folder={"corporate governance report"} />
